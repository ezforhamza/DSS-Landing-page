    ...
    Tables: {
      contact_submissions: {
        Row: {
          ...
          status: string
          submission_count_from_ip: number | null
          updated_at: string
...
export type AvailabilityType = "morning" | "noon" | "evening" | "weekends"
export type SubmissionStatus = "new" | "contacted" | "in_negotiation" | "converted" | "spam" | "rejected"
